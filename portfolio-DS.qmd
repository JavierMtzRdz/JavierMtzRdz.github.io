...
The data was processed with **{data.table}** and the dashboard built with **{shiny}**. It can be partially consulted <a href="https://javier-mtz-rd.shinyapps.io/dashboard_presupuesto/">here</a>.
